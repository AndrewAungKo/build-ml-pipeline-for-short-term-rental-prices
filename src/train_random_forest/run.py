...
def go(args):
    ...
    artifact = wandb.Artifact(
        args.output_artifact,  # Artifact name
        type="model_export",  # Artifact type
        description="Random Forest model trained on rental prices data",  # Description
        metadata=rf_config  # Metadata
    )

    # Add the directory containing the model to the artifact
